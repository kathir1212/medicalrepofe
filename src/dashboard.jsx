...
useEffect(() => {
  ...
  <div className="flex mt-[5rem]">
      ...
      <aside className="w-64 h-screen bg-gray-800 text-white p-4 space-y-4">
        <Link to="/dashboard/add-medicine" className="block hover:text-yellow-300">Add Medicine</Link>
        <Link to="/dashboard/list" className="block hover:text-yellow-300">MedicineList</Link>
