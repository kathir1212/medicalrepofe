...
<aside id="sidebar-multi-level-sidebar" class="mt-[5%] fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  ...
                  <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">All Movie Booking list</span>
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Add Threater</span>
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Add Show</span>
...
<div className="w-64 bg-gray-800 text-white min-h-screen p-4 space-y-4">
      ...
      <Link to="/add-medicine" className="block p-2 rounded hover:bg-gray-700">Add Theater</Link>
      <Link to="/add-show" className="block p-2 rounded hover:bg-gray-700">Add Show</Link>
    </div>
</>
  )
}
